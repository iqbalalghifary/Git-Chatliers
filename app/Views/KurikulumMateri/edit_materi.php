...
<div class="card">
   <div class="card-body">
      ...
      <h5 class="card-title fw-semibold mb-4">
         <i class="ti ti-bookmark"></i>Edit Materi
      </h5>


      <form action="<?= base_url('kurikulummateri/update/'.$materi['id'])?>" method="post" enctype="multipart/form-data">

         <div class="form-group mb-2">
            <label class="form-label" for="">Judul</label>
            <input type="text" class="form-control" value="<?=$materi['materi']?>" name="materi" required>
         </div>
         ...
         <div class="input-group border">
            ...
            <div class="form-group ms-3" id="media">
               ...
               <input class="form-control" onchange="getNumPages()" name='isi_materi' id="f-pdf" type="file" 
...
reader.onloadend = function(){
   ...
   $("#selectmedia").on('change', () => {
      ...
      if (media == "pdf") {
         $("#media").append(`
            <label for="">Pilih Pdf</label>
            <input class="form-control" onchange="getNumPages()" id="f-pdf" name='isi_materi' type="file"  accept="application/pdf">
            `)
      } else {
         $("#media").append(`
            <label for="">Pilih Video(mp4)</label>
            <input class="form-control" onchange="duration_video()"  id="f-video" name='isi_materi' type="file"   accept="video/mp4">
            `)
      }
   })
